...
IDA_CATALOG_IDENTIFIER = "urn:nbn:fi:att:data-catalog-ida"
DATASET_V3 = {
    'access_rights': {
        'available': None,
        'description': None,
...
CONTRACT_V3 = {
    "id": "agreement:identifier1",
    "title": {"und": "Agreement Title"},
    "description": {"und": "Agreement description"},
    "quota": 111204,
...
def create_test_v3_contract(**kwargs):
    return _create_merged_dict(CONTRACT_V3, **kwargs)


def create_test_v3_directory(**kwargs):
    return _create_merged_dict(DIRECTORY_V3, **kwargs)
